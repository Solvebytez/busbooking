...
const routes = [
    { title: 'Bangalore To Tirupati', imageUrl: 'https://busbooking.one67.in/public/frontend/images/route2.jpg' },
    { title: 'Bangalore To Ooty', imageUrl: 'https://busbooking.one67.in/public/frontend/images/route3.jpg' },
    { title: 'Bangalore To Mysore', imageUrl: 'https://busbooking.one67.in/public/frontend/images/route4.jpg' },
    { title: 'Bangalore To Goa', imageUrl: 'https://busbooking.one67.in/public/frontend/images/route5.jpg' },
    ...
    <Conatiner>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {routes.map((route, index) => (
          <div
            key={index}
            className="relative overflow-hidden rounded-lg shadow-lg group h-[14rem] w-[100%]"
          >
            <Image
            fill
              src={route.imageUrl}
